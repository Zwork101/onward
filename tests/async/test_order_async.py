...
def test_simple_run(executor: Executor) -> None:
	...
	@operation
	async def operation1(plan: SimpleOrder) -> FirstState:
	...
	@operation
	async def operation2(plan: SimpleOrder, first: FirstState) -> SecondState:
	...
	@operation
	async def operation3(plan: SimpleOrder, second: SecondState) -> ThirdState:
	...
	@operation
	async def operation4(plan: SimpleOrder, second: SecondState, third: ThirdState) -> None:
		plan.tracker.append("operation4")
		second.receivers.append("operation4")
		third.receivers.append("operation4")

	@operation
	async def operation5(plan: SimpleOrder, third: ThirdState) -> ForthState:
	...
	@operation
	async def operation6(plan: SimpleOrder, forth: ForthState) -> FifthState:
